    ...
    case "en":
        ?>
            ...
            <div>
                ...
                <p>Originated from<br /><a href="/rueckblick/<?php echo $lang; ?>" class="button">B&B-Conference 2018</a></p>
            </div>
    ...
    default:
        ?>
            ...
            <div>
                ...
                <p>Entstanden auf der<br /><a href="/rueckblick/<?php echo $lang; ?>" class="button">B&B-Konferenz 2018</a></p>
            </div>
