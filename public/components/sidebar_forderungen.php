...
<section class="switch support">
    ...
    <h2>
      <span><?php echo SupportController::getTotalNumberOfSupports(); ?> Supporters</span>
      <a href="/forderungen/unterzeichner/<?php echo $lang; ?>">
        <span class="smaller">See full list</span>
      </a>
    </h2>
  <p class="bold" style="margin-top: 0">already signed our demands.</p>
...
$url = (strpos($page, 'forderungen/info') !== false) ? '' : '/forderungen/' . $lang;
        ?>
<a href="<?php echo $url; ?>#unterzeichnen" class="button important" style="text-align: center"><span class="icon sign">Sign demands</span></a>
