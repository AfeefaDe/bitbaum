<div class="people">
    ...
    $people = array(
        ...
        array("name" => "Rolf Buschmann", "orga" => "BUND", "picture" => "/img/rolf-buschmann.jpg", "quote_de" => "Die Digitalisierung nachhaltig zu gestalten ist eine der größten Herausforderungen für unsere Gesellschaft. Mit der Konferenz <em>Bits & Bäume</em> setzen wir einen ersten wichtigen Meilenstein.", "quote_en" => "Making digitalization sustainable is one of the greatest challenges our society faces. With the conference <em>Bits & Bäume</em> we set a first milestone."),
