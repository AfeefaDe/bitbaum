<div class="people">
    ...
    $people = array(
        ...
        array("name" => "Anja Höfner", "orga" => "Institut für ökologische Wirtschaftsforschung (IÖW)", "picture" => "/img/anja-hoefner.jpg", "quote_de" => "Die <em>Bits & Bäume</em> bringt zusammen, was noch nicht zusammengehört:Techies auf der einen und Akteure aus der Umweltszene auf der anderen Seite – nur so wird eine nachhaltige digitale Zukunft gestaltbar!", "quote_en" => "<em>Bits & Bäume</em> brings together what does not yet belong together: Techies on the one hand and actors from the environmental scene on the other - this is the only way to shape a sustainable digital future!"),
        array("name" => "Tilman Santarius", "orga" => "Technische Universität Berlin", "picture" => "/img/tilman-santarius.jpg", "quote_de" => "<em>Bits & Bäume</em> möchte die Debatte über den Megatrend der Digitalisierung politisieren. Wir brauchen Ideen und Konzepte, wie wir die Digitalisierung zukunftsfähig gestalten können!", "quote_en" => "<em>Bits & Bäume</em> wants to politicise the debate on the megatrend of digitalization. We need ideas and concepts on how we can make digitalization sustainable!"),
        array("name" => "Rolf Buschmann", "orga" => "BUND", "picture" => "/img/rolf-buschmann.jpg", "quote_de" => "Die Digitalisierung nachhaltig zu gestalten ist eine der größten Herausforderungen für unsere Gesellschaft. Mit der Konferenz <em>Bits & Bäume</em> setzen wir einen ersten wichtigen Meilenstein.", "quote_en" => "Making digitalization sustainable is one of the greatest challenges facing our society. With the conference <em>Bits & Bäume</em> we set a first milestone."),
