<?php switch ($lang) {
    case "en":
        ...
        <section class="switch program active">
          ...
          <a href="https://media.ccc.de/c/bub2018" class="button" style="text-align: center">Recordings</a>
...
break;
    default:
        ...
        <section class="switch program active">
          ...
          <a href="https://media.ccc.de/c/bub2018" class="button" style="text-align: center">Aufzeichnungen</a>
          <p style="display: flex; justify-content: space-evenly;">
