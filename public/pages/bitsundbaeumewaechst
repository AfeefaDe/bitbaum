...
<ul>
          ...
          <section>
Folgendes legen wir Euch zusätzlich ans Herz:
<ul>
    ...
    <li>Vernetzung ermöglichen: Sorgt auch vor Ort explizit für Zeit und Raum zum Austausch und für Vernetzung. Verwendet gern und viel den Hashtag #bitsundbäume, z.B. auf Mastodon, Twitter oder Diaspora; wir greifen das via @bitsundbaeume gerne auf. </li>
...
<p>Wenn ihr Anregungen braucht oder hilfreiche Informationen bei uns vermutet, dann meldet euch gerne: Unter bewegung@bits-und-baeume.org erreicht ihr aktuell Juliane (OKF) und Rainer (FIfF). </p>
